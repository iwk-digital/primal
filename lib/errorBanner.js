...
export function showErrorBanner(
  ...
  if (uri) {
    ...
    const uriLabel = document.createTextNode("Attempted to load: ");
    const codeEl = document.createElement("code");
    codeEl.textContent = uri;
    uriDiv.appendChild(uriLabel);
    uriDiv.appendChild(codeEl);
  ...
  if (status) {
    ...
    statusCode.textContent = `${status.code} ${status.text}`;
    statusDiv.appendChild(statusLabel);
    statusDiv.appendChild(statusCode);
