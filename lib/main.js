...
async function traversalsComplete() {
  ...
  if (Object.keys(meiTargets).length > 0) {
    ...
    // Hide music scores loading spinner if no MEI targets
    hideLoadingSpinner("#h-music-scores");
  }
  ...
  // Hide text content loading spinner
  ...
  // Hide audio examples loading spinner
